...
from model.prob_lstm import ProbLSTM
import config
...
if __name__ == '__main__':
    ...
    basicLSTM = ProbLSTM(lstm_step=max_length, embedding=word_embedding, hidden_d=300,
                              Time=timestamp, Message=args.message)

    basicLSTM.setup(embedding=word_embedding)
    wrapper(model_name='prob-LSTM', model=basicLSTM, max_length=max_length, benchmark=0.70)